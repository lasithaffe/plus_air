    ...
    <section class="service-area">
        <div class="container">
            <div class="row align-items-end mb-50">
                <div class="col-md-8">
                    <div class="section-title">
                        <h2 class="title">Cruises Deals</h2>
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row service-active">
                <div class="col-lg-4">
                    <div class="cruises-item service-item">
                        <div class="cruises-icon">
                      
                        <img src="assets/img/cruisess-4.jpg" alt="">
                        <h2 class="title">Hilton Luxury cruisess *</h2>
                ...
                <div class="col-lg-4">
                    <div class="cruises-item service-item">
                        <div class="cruises-icon">
                            ...
                            <img src="assets/img/cruisess-1.jpg" alt="">
                ...
                <div class="col-lg-4">
                    <div class="cruises-item service-item">
                        ...
                        <img src="assets/img/cruisess-1.jpg" alt="">
                        <h2 class="title">IslandLuxe cruisess*</h2>
                        </div>
                                            ...
                                            <form action="{{ route('booking') }}">
                                                <div class="booking-form">
                                                    <ul>
                                                        <li>
                                                            <div class="form-grp">
                                                                <input type="text" id="fromAirport" name="fromAirport" class="form-control" placeholder="cruisess" list="list-timezone" id="input-datalist">
                                                                <datalist id="list-timezone" id="fromAirport" name="fromAirport">
                                                                    <?php foreach ($cruises as $key) { ?>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="section-title text-center">
                            ...
                            <h2 class="title">Our cruisess Partner</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 grid-item grid-sizer cat-two">
                        <div class="fly-next-item3 fly-next-item">
                            <div class="fly-next-v3 fly-next-thumb">
                                ...
                                <img src="assets/img/cruisess/<?= $key->img ?>" alt="">
                                </div>
